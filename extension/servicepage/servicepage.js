...
document.addEventListener( 'DOMContentLoaded', function() {
  const toAccount = document.getElementById( 'sp-settings' );
...
// Netflix Listener
document.addEventListener( 'DOMContentLoaded', function() {
  const netflixCheck = document.getElementById( 'sp-netflix' );
...
// Hulu Listener
document.addEventListener( 'DOMContentLoaded', function() {
  const huluCheck = document.getElementById( 'sp-hulu' );
...
// HBO Listener
document.addEventListener( 'DOMContentLoaded', function() {
  const hboCheck = document.getElementById( 'sp-hbo' );
